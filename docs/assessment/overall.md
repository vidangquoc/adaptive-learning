...
The conceptual Challenge model is described in [Challenge](challenge.md), and its canonical structure is defined in [Challenge Structure](challenge-extraction/structure.md).
