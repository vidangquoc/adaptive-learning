...
Sources are the external or repository-preserved materials from which Adaptive Learning derives trustworthy learning-material evidence.

A source provides the evidence backbone for knowledge construction and source-derived assessment. Source management preserves the distinction between the original source, its structural segmentation, derived representations, and downstream interpretation.
