...
The Segment architecture defined by `docs/source/source-structure.md` is the canonical source boundary. If a future implementation detail conflicts with that architecture or another canonical learning-material principle, preserve the principle and adapt the implementation.
