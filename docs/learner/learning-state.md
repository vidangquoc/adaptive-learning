...
Every meaningful assessment interaction should generate an event. Recommended fields include:
...
A statistical model can be added later if accumulated attempt history justifies it.
