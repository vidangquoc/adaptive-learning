...
- [x] Canonical project context and status moved to `context-recover/`
...
`context-recover/PROJECT-CONTEXT.md` and `context-recover/PROJECT-STATUS.md` are recovery/status documents, not the authoritative home for detailed project specifications or data documentation.
